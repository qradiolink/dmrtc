...
public:
    ...
    static std::string dump(int level, const std::string& title, const unsigned char* data, unsigned int length);
    ...
    static void extractGPSPosition(unsigned char *data, std::string &error, float &longitude, float &latitude);
